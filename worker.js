onmessage= function(e){
	let word1=e.data[0], word2=e.data[1], word3=e.data[2], op=e.data[3], timeout=e.data[4];
	...
	do{
		counter++;
		let output=check(word1,word2,word3, op);
...
function check(word1,word2,word3,op){
	let uniqueLetters=[];
	let uniqueDigits=[];
	...
	if(number1+number2==number3 || number1-number2==number3 || number1*number2==number3 || number1/number2==number3){
		return {
			result:true,
			number1:number1str,
			number2:number2str,
